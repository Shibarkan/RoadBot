...
import { FaRobot, FaSatelliteDish, FaTools, FaArrowRight, FaPlay, FaShoppingCart } from "react-icons/fa";
...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative w-full min-h-[85vh] flex flex-col items-center justify-center text-center px-6 pt-20 pb-10 z-10 overflow-hidden">
      ...
      >
        Teknologi robot otomatis terintegrasi IoT untuk mendeteksi, memetakan, dan memperbaiki kerusakan infrastruktur jalan secara real-time.
      </motion.p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 max-w-4xl w-full">
        {/* IoT Highlight */}
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: false, amount: 0.3 }} variants={fadeInLeft} className="bg-black/40 backdrop-blur-md border border-white/10 p-5 rounded-2xl flex items-center gap-4 hover:border-blue-500/50 transition-colors">
        ...
        {/* AI Highlight */}
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: false, amount: 0.3 }} variants={fadeInUp} className="bg-black/40 backdrop-blur-md border border-white/10 p-5 rounded-2xl flex items-center gap-4 hover:border-cyan-400/50 transition-colors">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: false, amount: 0.3 }} variants={fadeInRight} className="bg-black/40 backdrop-blur-md border border-white/10 p-5 rounded-2xl flex items-center gap-4 hover:border-blue-400/50 transition-colors">
